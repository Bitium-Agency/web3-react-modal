...
const WalletsModal = ({
  ...
  const Walletbutton_modal_item = styled.button`
    width: 100%;
    padding: 10px;
    border: none;
    border-radius: 5px;
  ...
  `;
  const Walletbutton_modal_title = styled.span`
    font-size: 14px;
    font-weight: bold;
    color: #212121;
    margin-bottom: 25px;
    margin-top: 15px;
  `;
  const Walletbutton_modal_container = styled.div`
    display: flex;
  ...
  return showModal ? (
    ...
    >
      ...
      >
        <Walletbutton_modal_title className="walletbutton-modal-title" >Select a wallet</Walletbutton_modal_title>
        <Walletbutton_modal_item  className="walletbutton-modal-item" onClick={activeInjected}>
        Metamask<img src={metamaskLogo} alt="metamask" style={{ width: "30px", height: "30px" }} />
          </Walletbutton_modal_item>
        {getConnectors()?.walletconnect && <Walletbutton_modal_item className="walletbutton-modal-item" onClick={activeWalletconnect}>
        Walletconnect <img src={walletConnectLogo} alt="metamask" style={{ width: "30px", height: "30px" }} />
          </Walletbutton_modal_item>}
      </Walletbutton_modal_container>
    </div>
  ) : (
