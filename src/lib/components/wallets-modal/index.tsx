...
function WalletsModal({
  ...
  const activeInjected = async () => {
    if ((window as any)?.ethereum && !supportedChains.find((c) => +c.chainId === +chainId)) {
    ...
    useAccountListener((window as any)?.ethereum, (accounts: any) => {
    ...
    >
      <WalletbuttonModalContainer ref={modalContainer} className="walletbutton-modal-container">
        ...
        <WalletbuttonModalItem className="walletbutton-modal-item" onClick={activeInjected}>
          Metamask
          <img src={metamaskLogo} alt="metamask" style={{ width: "30px", height: "30px" }} />
        </WalletbuttonModalItem>
        {getConnectors()?.walletconnect && (
          <WalletbuttonModalItem className="walletbutton-modal-item" onClick={activeWalletconnect}>
            Walletconnect{" "}
            <img src={walletConnectLogo} alt="metamask" style={{ width: "30px", height: "30px" }} />
          </WalletbuttonModalItem>
        )}
