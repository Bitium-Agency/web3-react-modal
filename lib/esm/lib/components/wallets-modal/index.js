...
var WalletsModal = function (_a) {
    ...
    return showModal ? (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: {
            ...
            "WalletsModal",
            React.createElement("button", { onClick: activeInjected }, "metamask"),
            React.createElement("button", { onClick: activeWalletconnect }, "walletconnect")))) : (React.createElement(React.Fragment, null));
};
