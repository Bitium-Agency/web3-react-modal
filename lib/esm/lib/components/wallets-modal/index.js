...
var WalletsModal = function (_a) {
    ...
    return showModal ? (React.createElement("div", { style: {
        ...
        React.createElement(Walletbutton_modal_container, { style: {
                width: "200px",
                height: "fit-content",
            ...
            ((_b = getConnectors()) === null || _b === void 0 ? void 0 : _b.walletconnect) && React.createElement(Walletbutton_modal_item, { className: "walletbutton-modal-item", onClick: activeWalletconnect },
                "Walletconnect ",
                React.createElement("img", { src: walletConnectLogo, alt: "metamask", style: { width: "30px", height: "30px" } }))))) : (React.createElement(React.Fragment, null));
};
