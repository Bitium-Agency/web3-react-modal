...
var useOutsiteClick_1 = __importDefault(require("../../../hooks/useOutsiteClick"));
...
function WalletsModal(_a) {
    ...
    var modalContainer = (0, react_1.useRef)(null);
    (0, useOutsiteClick_1.default)(modalContainer, function () {
        setShowModal(false);
    });
    return showModal ? (react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement(Walletbutton_modal_container, { ref: modalContainer, className: "walletbutton-modal-container" },
            ...
            ((_b = (0, storage_1.getConnectors)()) === null || _b === void 0 ? void 0 : _b.walletconnect) && (react_1.default.createElement(Walletbutton_modal_item, { className: "walletbutton-modal-item", onClick: activeWalletconnect },
                "Walletconnect",
                ' ',
                react_1.default.createElement("img", { src: walletConnectLogo, alt: "metamask", style: { width: '30px', height: '30px' } })))))) : (
