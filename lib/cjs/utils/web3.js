...
exports.connectors = exports.switchNetwork = void 0;
...
var switchNetwork = function (chainId, provider) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!(provider.networkVersion !== chainId)) return [3 /*break*/, 6];
          _a.label = 1;
        case 1:
          _a.trys.push([1, 3, , 6]);
          return [
            ...
            provider.request({
              ...
              params: [{ chainId: ethers_1.ethers.utils.hexValue(chainId) }],
            }),
          ];
        case 2:
          _a.sent();
              ...
              params: [
                {
                  ...
                  chainId: ethers_1.ethers.utils.hexValue(chainId),
                  nativeCurrency: {
                    name: "MATIC",
                    decimals: 18,
                    symbol: "MATIC",
...
exports.connectors = { injected: injected, walletconnect: walletconnect };
