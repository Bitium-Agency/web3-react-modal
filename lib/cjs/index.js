...
function WalletButton(_a) {
    ...
    return (react_1.default.createElement(wallet_button_1.default, { supportedChains: supportedChains, useWeb3React: useWeb3React, onError: onError, walletConnectConfigs: walletConnectConfigs, ButtonProps: ButtonProps }));
}
